...
# # FOLDER_PATH_10k_EXTRACTION = '/home/rahul/Documents/personal-projects/common_investor_backend/ci_rest_api_server'
# FOLDER_PATH_10k_EXTRACTION = '/home/rahul/Downloads'
...
#         #                     # end_date=end_date,
#         #                     user_agent= "Rahul (rahul18cracker@gmail.com)")
...
#             print(f"Got an exception while pulling {e}")
#             # self.fail("cannot pull data ")

#         try:
#             my_filings.save(FOLDER_PATH_10k_EXTRACTION)
#         except Exception as f:
#             print(f"Unable to save to location{f}")
#             # self.fail("Not abel to save file ")
